//strlen(a), strcpy(a,b), strcat(a,b), strchr(a,ch), strcmp(a,b)
//strlen: expects string as an arguement and returns the length of the string, excluding the NULL character
//strcat: expects two strings and copies the value of b to a
